    ...
    return (
        <Svg style={style} width={width} height={height} fill={fill} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.25 18.595">
            <G id="map-svgrepo-com" transform="translate(-2.375 -2.702)">
                ...
                <Path id="Path_176" data-name="Path 176" d="M9,6.639V20.5" fill="none" stroke="#fff" stroke-width="1.25" />
                <Path id="Path_177" data-name="Path 177" d="M15,3V17" fill="none" stroke="#fff" stroke-width="1.25" />
            </G>
        </Svg>
    )
}
